...
const Navbar = () => {
    ...
    const handleSignUp = () => navigate('/role'); // redirect to Role page
                    ...
                    <div className='hidden md:flex flex-row items-center space-x-8'>
                        <ul className='flex space-x-8 text-lg font-medium'>
                            {['Home', 'Features', 'Community', 'About', 'Contact'].map((item) => (
                                <li
                                    key={item}
                                    className='cursor-pointer p-1 rounded-lg transition duration-200 hover:bg-indigo-600 hover:rounded-3xl hover:py-2 hover:px-3 hover:text-white'
                                >
                                    {item}
                                </li>
                            ))}
